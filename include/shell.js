...
function run_script(script)
{
    ...
    {
        document.write("</br>");document.write("RunScriptError: " + e);
    }
}
...
function log_out(text)
{
	...
	{
        document.write("</br>");document.write("LogOutError: " + e);
    }
}
...
function do_read(aspace, addr, len)
{
    try {
        ...
        document.write("</br>");document.write("ReadError: " + e);
    }
}
    ...
    try {
        if (len <= 30000) {
            ...
            while (n > 30000) {
				...
				// Print progress.
				document.write("</br>");document.write("Dumping " + fname + ": %"+ (100 - (n/len * 100)).toString() + "\033[1A\r");
            }
            var bytes = get_bytes(aspace, xaddr, n);
            sendcmsg("dump", xaddr, bytes, fname);
        }
		document.write("</br>");document.write("Dumped " + fname);
    } catch(e) {
        document.write("</br>");document.write("DumpError: " + e);
    }
}
...
function do_dis(aspace, addr, len, mode)
{
    try {
        ...
        document.write("</br>");document.write("DisasmError: " + e);
    }
}
...
function do_search(aspace, begaddr, endaddr, pattern)
{
    try {
        ...
        var reverse = false;
        if (endaddr == begaddr) {
            document.write("</br>");document.write("SearchError: ss begaddr must not equal endaddr");
            return;
        }
        if(endaddr <= begaddr){
            document.write("</br>");document.write("Searching in reverse");
            reverse = true;
        }
        ...
        for(var i = begaddr; i != endaddr;){
           ...
           if ((i % 0x10000) == 0) {
               document.write("</br>");document.write("0x" + i.toString(16) + " ...");
           }
           if (cb == tb) {
               score += 1;
        ...
        if (found == -1) {
            document.write("</br>");document.write("Pattern not found");
        } else {
            document.write("</br>");document.write("Pattern " + pattern + " found at: 0x" + found.toString(16));
            return found;
        }
    } catch(e) {
        document.write("</br>");document.write("SearchError: " + e);
    }
}
...
function do_search_hex(aspace, begaddr, endaddr, pattern)
{
    try {
        ...
        if (pattern.length % 2){
            document.write("</br>");document.write("SearchError: pattern must be a multiple of 2");
            return;
        }
...
function scan_back(aspace, begaddr, step)
{
    ...
    while(true) {
        ...
        document.write("</br>");document.write("Last accessed: 0x" + curr.toString(16));
        curr -= step;
    }
}
...
function scan_mod_info(aspace, addr)
{
    try {
        ...
        while(true) {
            ...
            if (modver != "0101") {
                document.write("</br>");document.write("Module scanner found false positive at: 0x" + maddr.toString(16));
        ...
        document.write("</br>");document.write("ModScanError: " + e);
    }
}
...
function disp_minfo(aspace, addr)
{
    try {
        ...
        document.write("</br>");document.write("DisplayError: " + e);
    }
}
...
function shell(aspace)
{
    try {
        while(true) {
            ...
            var cmd_s = cmd.split(" ");
            if(cmd_s[0] == "exit") {
                document.write("</br>");document.write("Exiting...");
                return;
            }
            else if (cmd_s[0] == "read") {
                if (cmd_s.length < 3) {
                    document.write("</br>");document.write("read <addr> <len>");
                    continue;
                }
                ...
                if (cmd_s.length < 3) {
                    document.write("</br>");document.write("disasm <addr> <len> <mode>");
                    continue;
                }
                var mode = "arm";
                if (cmd_s.length > 3) {
                ...
                if (cmd_s.length < 3) {
                    document.write("</br>");document.write("dump <addr> <len> <outfile>");
                    continue;
                }
                var addr = Number(cmd_s[1]);
                var len = Number(cmd_s[2]);
                ...
                if(cmd_s.length < 3) {
                    document.write("</br>");document.write("ss <beginaddr> <endaddr> <pattern>");
                    continue;
                }
                ...
                if (cmd_s.length < 3) {
                    document.write("</br>");document.write("sh <beginaddr> <endaddr> <hex pattern>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                var endaddr = Number(cmd_s[2]);
                ...
                if (cmd_s.length < 2) {
                    document.write("</br>");document.write("scanm <beginaddr>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                ...
                if (cmd_s.length < 2) {
                    document.write("</br>");document.write("dispx <beginaddr> <n>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                var n = 1;
                ...
                if (cmd_s.length < 2) {
                    document.write("</br>");document.write("dispim <beginaddr> <n>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                var n = 1;
                ...
                if (cmd_s.length < 2) {
                    document.write("</br>");document.write("dispminf <beginaddr>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                ...
                if (cmd_s.length < 3) {
                    document.write("</br>");document.write("scanback <begaddr> <step>");
                    continue;
                }
                var begaddr = Number(cmd_s[1]);
                ...
                document.write("</br>");document.write("Reloading...");
                location.reload(true);
                return;
            }
			else if(cmd_s[0] == "run") {
				if (cmd_s.length < 2) {
                    document.write("</br>");document.write("run <script>");
                    continue;
                }
				document.write("</br>");document.write("Running...");
                run_script(cmd.substring(4, cmd.length));
            }
			else if(cmd_s[0] == "help") {
				document.write("</br>");document.write("Commands: ");
				document.write("</br>");document.write("run <script>");
				document.write("</br>");document.write("read <addr> <len>");
				document.write("</br>");document.write("disasm <addr> <len> <mode>");
				document.write("</br>");document.write("dump <addr> <len> <outfile>");
				document.write("</br>");document.write("ss <beginaddr> <endaddr> <pattern>");
				document.write("</br>");document.write("sh <beginaddr> <endaddr> <hexpattern>");
				document.write("</br>");document.write("scanm <beginaddr>");
				document.write("</br>");document.write("dispx <beginaddr> <n>");
				document.write("</br>");document.write("dispim <beginaddr> <n>");
				document.write("</br>");document.write("dispminf <beginaddr>");
				document.write("</br>");document.write("scanback <begaddr> <step>");
				document.write("</br>");document.write("help");
				document.write("</br>");document.write("reload");
				document.write("</br>");document.write("exit\n");
			}
            else{
                document.write("</br>");document.write("Unknown command: " + cmd_s[0]);
            }
        }
    } catch(e) {
