...
function myprintf(addr)
{
    ...
    document.write("</br>");document.write(res);
}
...
function getcmd()
{
    try {
        ...
        document.write("</br>");document.write("GetCMDError: " + e);
        return "FAIL";
    }
    return cmd;
}
...
function sendcmsg(type, addr, txt, extra)
{
    try {
        ...
        document.write("</br>");document.write("SendCMsgError: " + e);
    }
}
...
*/
function document.write("</br>");document.write(txt)
{
    sendmsg(txt);
}
